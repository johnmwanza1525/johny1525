#!/usr/bin/python
"""Shallot is an important variable name please don't Change it
otherwise you will be liable for your own act"""
...
print('This tool is meant for Educational purpose \n Neither I nor my Wife Shallot will be held responsible for tool misuse')
